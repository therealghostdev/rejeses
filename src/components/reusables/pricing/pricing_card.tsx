              ...
              onClick={() =>
                registerBtnClick(
                  ...
                  decodeURIComponent(pathname).split("/")[1] === "training"
                    ? `You are subscribing to rejeses 35-hour training plan. You will be charged  ${
                        isNigeria ? "NGN " : "$"
                      }${
                        isNigeria
                          ? formatPrice(training_only.price2)
                    ...
                    : `You are subscribing to rejeses 3-month mentoring plan. You will be charged ${
                        isNigeria ? "NGN " : "$"
                      }${
                        isNigeria
                          ? formatPrice(training_only.price2)
            ...
            <button
              onClick={() =>
                registerBtnClick(
                  ...
                  `You are subscribing to rejeses 35-hour training plus 3-month mentoring plan. You will be charged ${
                    isNigeria ? "NGN " : "$"
                  }${
                    isNigeria
                      ? formatPrice(training_with_mentorship.price2)
